...
export default function EnqForm({ onClose }) {
    ...
    return (
        <form className='flex justify-center items-center sm:py-4 animate-slideDown sm:px-4 bg-[rgba(0,0,0,0.5)] h-screen' onSubmit={handleSubmit} >
            <div className='w-full max-w-[900px] mx-auto'>
                <div className="text-center w-full">
                    <svg className="text-gray-100 h-0 mx-auto" fill-current viewBox="0 0 150 29" version="1.1"
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Desktop-HD" transform="translate(-1112.000000, -438.000000)" fill-current>
                ...
                <div
                    className="max-w-screen-xl grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-10 px-1 py-6 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg relative">
                    <div className="flex flex-col justify-between">
                        <div>
                            <RxCross2
                                className='absolute right-2 top-2 text-xl cursor-pointer hover:text-red-500'
                                onClick={onClose}
                            />
                            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight">Lets talk about everything!</h2>
                            <div className="text-gray-700 mt-8">
                                Hate forms? Send us an <span className="underline">email</span> instead.
                            </div>
                        </div>
                        <div className="mt-5 text-center sm:block hidden ">
                    ...
                    <div className="">
                        ...
                        <div className="mt-3">
                            <span className="uppercase text-sm text-gray-600 font-bold">Phone Number</span>
                            <input className="w-full bg-gray-300 text-gray-900 mt-1 p-2 rounded-lg focus:outline-none focus:shadow-outline"
